...
import "../ERC165.sol";
import "../SafeMath.sol";
import "../WhitelistedBreeder.sol";

/**
 * @title ERC721 Non-Fungible Token Standard basic implementation
 * @dev see https://eips.ethereum.org/EIPS/eip-721
 */
contract ERC721 is Context, ERC165, IERC721, WhitelistedBreeder {
	...
	*/
     ...
     */
    function transferFrom(address from, address to, uint256 tokenId) onlyWhitelistedBreeder public {
     ...
     * @param tokenId uint256 ID of the token to be transferred
     */
    function safeTransferFrom(address from, address to, uint256 tokenId) onlyWhitelistedBreeder public {
     ...
     */
    function safeTransferFrom(address from, address to, uint256 tokenId, bytes memory _data) onlyWhitelistedBreeder public {
        require(_isApprovedOrOwner(_msgSender(), tokenId), "ERC721: transfer caller is not owner nor approved");
